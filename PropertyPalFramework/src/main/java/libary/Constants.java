...
public class Constants {
	...
	public static final String[] MIN_AMOUNT = {"Any","€20,000 min","€30,000 min","€40,000 min","€50,000 min","€60,000 min","€2,000,000 min"};
	public static final String[] MAX_AMOUNT = {"Any","€20,000 max","€30,000 max","€40,000 max","€50,000 max","€60,000 min","€2,000,000 max"};
